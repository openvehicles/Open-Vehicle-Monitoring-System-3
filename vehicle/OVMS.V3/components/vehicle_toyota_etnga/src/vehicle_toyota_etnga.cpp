...
static const OvmsVehicle::poll_pid_t obdii_polls[] = {
  ...
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_READY_SIGNAL, { 0, 5, 1, 60}, 0, ISOTP_STD }, // { 0, 5, 1, 60}
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_CHARGING_LID, { 0, 5, 60, 1}, 0, ISOTP_STD }, // { 0, 5, 60, 1}
