...
static const OvmsVehicle::poll_pid_t obdii_polls[] = {
  ...
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_CHARGING_LID, { 0, 5, 0, 1}, 0, ISOTP_STD }, // { 0, 5, 0, 1}
    ...
    // Driving polls
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_BATTERY_VOLTAGE_AND_CURRENT, { 0, 0, 1, 1}, 0, ISOTP_STD }, // { 0, 120, 1, 1}
  { VEHICLE_OBD_BROADCAST_MODULE_TX, HPCM_HYBRIDPTCTR_RX, VEHICLE_POLL_TYPE_OBDIICURRENT, PID_ODOMETER, { 0, 0, 1, 0}, 0, ISOTP_STD }, // {0, 120, 1, 0}
  ...
  { VEHICLE_OBD_BROADCAST_MODULE_TX, HPCM_HYBRIDPTCTR_RX, VEHICLE_POLL_TYPE_OBDIICURRENT, PID_AMBIENT_TEMPERATURE, { 0, 0, 15, 15}, 0, ISOTP_STD }, // { 0, 120, 15, 15}
  { HYBRID_BATTERY_SYSTEM_TX, HYBRID_BATTERY_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_BATTERY_TEMPERATURES, { 0, 0, 15, 15}, 0, ISOTP_STD }, // { 0, 3600, 15, 15}
