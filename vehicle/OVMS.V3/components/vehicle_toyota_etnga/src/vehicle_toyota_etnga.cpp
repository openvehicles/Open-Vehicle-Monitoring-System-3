...
static const OvmsVehicle::poll_pid_t obdii_polls[] = {
  ...
  { HYBRID_CONTROL_SYSTEM_TX, HYBRID_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_READY_SIGNAL, { 0, 5, 2, 0}, 0, ISOTP_STD },
  { PLUG_IN_CONTROL_SYSTEM_TX, PLUG_IN_CONTROL_SYSTEM_RX, VEHICLE_POLL_TYPE_READDATA, PID_CHARGING_LIDS_SWITCH, { 0, 5, 0, 2}, 0, ISOTP_STD },
