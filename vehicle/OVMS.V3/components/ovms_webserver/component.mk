...
COMPONENT_EMBED_FILES := assets/script.js.gz assets/style.css.gz assets/favicon.png
...
src/web_framework.o: $(COMPONENT_PATH)/assets/script.js.gz $(COMPONENT_PATH)/assets/style.css.gz $(COMPONENT_PATH)/assets/favicon.png
