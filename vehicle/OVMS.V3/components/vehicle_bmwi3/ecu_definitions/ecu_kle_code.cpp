...
//
  ...
  case I3_PID_KLE_BETRIEBSZUSTAND_LADEGERAET: {                                   // 0xDE84
    ...
    unsigned char BF_LADEGERAET_DERATING = (RXBUF_UCHAR(1));
        // Reason for derating / Grund f체r Derating
    ...
    unsigned char BF_LADEGERAET_FEHLERZUSTAND_UCXII = (RXBUF_UCHAR(5));
        // Charger fault conditions / Ladeger채t Fehlerzust채nde 
    ...
    unsigned short BF_AUSLOESER_FAILSAFE_UCXII = (RXBUF_UINT(6));
        // Failsafe trigger / Ausl철ser Failsafe
    ...
    unsigned char BF_LADEGERAET_URSACHE_LADEUNTERBRECHUNG = (RXBUF_UCHAR(8));
        // Cause of charging interruption / Ursache f체r Ladeunterbrechung
    ...
    unsigned long BF_MOD_ERR = (RXBUF_UINT32(12));
        // Error states load module / Fehlerzust채nde Lademodul
  ...
  case I3_PID_KLE_LADEGERAET_TEMPERATUREN: {                                      // 0xDFB1
    ...
    ESP_LOGD(TAG, "From ECU %s, pid %s: got %s=%x%s\n", "KLE", "LADEGERAET_TEMPERATUREN", "STAT_NTC1_TEMPERATUR_WERT", STAT_NTC1_TEMPERATUR_WERT, "\"째C\"");
    ...
    ESP_LOGD(TAG, "From ECU %s, pid %s: got %s=%x%s\n", "KLE", "LADEGERAET_TEMPERATUREN", "STAT_NTC2_TEMPERATUR_WERT", STAT_NTC2_TEMPERATUR_WERT, "\"째C\"");
    ...
    ESP_LOGD(TAG, "From ECU %s, pid %s: got %s=%x%s\n", "KLE", "LADEGERAET_TEMPERATUREN", "STAT_NTC3_TEMPERATUR_WERT", STAT_NTC3_TEMPERATUR_WERT, "\"째C\"");
    ...
    ESP_LOGD(TAG, "From ECU %s, pid %s: got %s=%x%s\n", "KLE", "LADEGERAET_TEMPERATUREN", "STAT_NTC4_TEMPERATUR_WERT", STAT_NTC4_TEMPERATUR_WERT, "\"째C\"");
    ...
    ESP_LOGD(TAG, "From ECU %s, pid %s: got %s=%x%s\n", "KLE", "LADEGERAET_TEMPERATUREN", "STAT_NTC5_TEMPERATUR_WERT", STAT_NTC5_TEMPERATUR_WERT, "\"째C\"");
    ...
    ESP_LOGD(TAG, "From ECU %s, pid %s: got %s=%x%s\n", "KLE", "LADEGERAET_TEMPERATUREN", "STAT_NTC6_TEMPERATUR_WERT", STAT_NTC6_TEMPERATUR_WERT, "\"째C\"");
    ...
    ESP_LOGD(TAG, "From ECU %s, pid %s: got %s=%x%s\n", "KLE", "LADEGERAET_TEMPERATUREN", "STAT_NTC7_TEMPERAUTR_WERT", STAT_NTC7_TEMPERAUTR_WERT, "\"째C\"");
    ...
    ESP_LOGD(TAG, "From ECU %s, pid %s: got %s=%x%s\n", "KLE", "LADEGERAET_TEMPERATUREN", "STAT_NTC8_TEMPERATUR_WERT", STAT_NTC8_TEMPERATUR_WERT, "\"째C\"");
    ...
    ESP_LOGD(TAG, "From ECU %s, pid %s: got %s=%x%s\n", "KLE", "LADEGERAET_TEMPERATUREN", "STAT_NTC9_TEMPEARTUR_WERT", STAT_NTC9_TEMPEARTUR_WERT, "\"째C\"");
    ...
    ESP_LOGD(TAG, "From ECU %s, pid %s: got %s=%x%s\n", "KLE", "LADEGERAET_TEMPERATUREN", "STAT_NTC10_TEMPEARTUR_WERT", STAT_NTC10_TEMPEARTUR_WERT, "\"째C\"");
  ...
  case I3_PID_KLE_LADEGERAET_LADE_HISTOGRAMM: {                                   // 0xDFB6
    ...
    unsigned long STAT_SEKUNDEN_TEMPERATUR_BEREICH_1_WERT = (RXBUF_UINT32(0));
        // Seconds at temperature below 0 � C / Sekunden bei Temperatur unter 0째C
    ...
    unsigned long STAT_SEKUNDEN_TEMPERATUR_BEREICH_2_WERT = (RXBUF_UINT32(4));
        // Seconds at a temperature between 0 � C and 45 � C / Sekunden bei Temperatur zwischen 0째C und 45째C
    ...
    unsigned long STAT_SEKUNDEN_TEMPERATUR_BEREICH_3_WERT = (RXBUF_UINT32(8));
        // Seconds at a temperature between 46 � C and 60 � C / Sekunden bei Temperatur zwischen 46째C und 60째C
    ...
    unsigned long STAT_SEKUNDEN_TEMPERATUR_BEREICH_4_WERT = (RXBUF_UINT32(12));
        // Seconds in the temperature range between 61 � C and 70 � C / Sekunden im Temperaturbereich zwischen 61째C und
        // 70째C
    ...
    unsigned long STAT_SEKUNDEN_TEMPERATUR_BEREICH_5_WERT = (RXBUF_UINT32(16));
        // Seconds at a temperature between 71 � C and 85 � C / Sekunden bei Temperatur zwischen 71째C und 85째C
    ...
    unsigned long STAT_SEKUNDEN_TEMPERATUR_BEREICH_6_WERT = (RXBUF_UINT32(20));
        // Seconds at temperatures above 85 � C / Sekunden bei Temperatur 체ber 85째C
    ...
    unsigned long STAT_SEKUNDEN_LEISTUNG_BEREICH_4_WERT = (RXBUF_UINT32(36));
        // Seconds at power over 3000W / Sekunden bei Leistung 체ber 3000W
  ...
  case I3_PID_KLE_UMSCHALTMATRIX: {                                               // 0xDFB9
    ...
    unsigned long STAT_SCHALTER1_SCHALTZYKLEN_ANZAHL_WERT = (RXBUF_UINT32(0));
        // Number of switching cycles for switch 1 (multi-phase charging: phase 1) / Anzahl von Schaltzyklen f체r
    ...
    unsigned long STAT_SCHALTER2_SCHALTZYKLEN_ANZAHL_WERT = (RXBUF_UINT32(4));
        // Number of switching cycles for switch 2 (multi-phase charging: phase 2) / Anzahl von Schaltzyklen f체r
    ...
    unsigned long STAT_SCHALTER3_SCHALTZYKLEN_ANZAHL_WERT = (RXBUF_UINT32(8));
        // Number of switching cycles for switch 3 (multi-phase charging: phase 3) / Anzahl von Schaltzyklen f체r
    ...
    unsigned long STAT_SCHALTER4_SCHALTZYKLEN_ANZAHL_WERT = (RXBUF_UINT32(12));
        // Number of switching cycles for switch 4 (multi-phase charging: changeover) / Anzahl von Schaltzyklen f체r
    ...
    unsigned char STAT_SCHALTER4 = (RXBUF_UCHAR(19));
        // State of switch 4 (0 = charger 1, 1 = charger 2) / Zustand vom Schalter 4 (0= Ladeger채t 1, 1=Ladeger채t 2)
  ...
  case I3_PID_KLE_LADEDAUER_LADEART: {                                            // 0xDFBD
    ...
    unsigned long STAT_MINUTEN_LADEZYKLUS_1PH_WERT = (RXBUF_UINT32(0));
        // Charging time in minutes for single-phase charging / Ladezeit in Minuten f체r einphasiges Laden
    ...
    unsigned short STAT_SEKUNDEN_LADEZYKLUS_1PH_WERT = (RXBUF_UINT(4));
        // Charging time in seconds for single-phase charging / Ladezeit in Sekunden f체r einphasiges Laden
    ...
    unsigned long STAT_MINUTEN_LADEZYKLUS_3PH_WERT = (RXBUF_UINT32(8));
        // Charging time in minutes for multi-phase charging / Ladezeit in Minuten f체r mehrphasiges Laden
    ...
    unsigned short STAT_SEKUNDEN_LADEZYKLUS_3PH_WERT = (RXBUF_UINT(12));
        // Charging time in seconds for multi-phase charging / Ladezeit in Sekunden f체r mehrphasiges Laden
